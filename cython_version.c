...
static PyObject *__pyx_f_14cython_version_test(int, int __pyx_skip_dispatch); /*proto*/
...
static PyObject *__pyx_pf_14cython_version_test(CYTHON_UNUSED PyObject *__pyx_self, int __pyx_v_x); /* proto */
/* Late includes */
...
static PyObject *__pyx_pw_14cython_version_1test(PyObject *__pyx_self, PyObject *__pyx_arg_x); /*proto*/
static PyObject *__pyx_f_14cython_version_test(int __pyx_v_x, CYTHON_UNUSED int __pyx_skip_dispatch) {
  int __pyx_v_y;
  int __pyx_v_i;
 ...
 */
  ...
  __Pyx_AddTraceback("cython_version.test", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __pyx_r = 0;
  __pyx_L0:;
...
/* Python wrapper */
static PyObject *__pyx_pw_14cython_version_1test(PyObject *__pyx_self, PyObject *__pyx_arg_x); /*proto*/
static PyObject *__pyx_pw_14cython_version_1test(PyObject *__pyx_self, PyObject *__pyx_arg_x) {
  int __pyx_v_x;
  int __pyx_lineno = 0;
  const char *__pyx_filename = NULL;
  int __pyx_clineno = 0;
  ...
  __pyx_r = __pyx_pf_14cython_version_test(__pyx_self, ((int)__pyx_v_x));
...
static PyObject *__pyx_pf_14cython_version_test(CYTHON_UNUSED PyObject *__pyx_self, int __pyx_v_x) {
  PyObject *__pyx_r = NULL;
  __Pyx_RefNannyDeclarations
  ...
  __Pyx_RefNannySetupContext("test", 0);
  __Pyx_XDECREF(__pyx_r);
  __pyx_t_1 = __pyx_f_14cython_version_test(__pyx_v_x, 0); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 1, __pyx_L1_error)
...
static PyMethodDef __pyx_methods[] = {
  {"test", (PyCFunction)__pyx_pw_14cython_version_1test, METH_O, 0},
  {0, 0, 0, 0}
};
